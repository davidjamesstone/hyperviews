...
- `name` - The output function name (can be overridden with a `<function>` element). The default is `view`.
- `args` - The output function arguments (can be overridden with a `<function>` element). The default is `state actions`.
